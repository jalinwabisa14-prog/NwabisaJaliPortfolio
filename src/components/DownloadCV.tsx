import { Download, FileText, Mail, Linkedin, Github, Printer } from 'lucide-react';
          ...
          <div className="md:col-span-2 p-8 rounded-2xl bg-gradient-to-br from-slate-800/60 to-slate-900/60 border border-slate-700/50 hover:border-purple-500/30 transition-all duration-300">
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                <h3 className="text-white font-bold text-xl mb-2">Nwabisa_Q_Jali_CV</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  Full curriculum vitae including education, work experience, certifications,
                  skills, and contact details. Opens as a print-ready page where you can save
                  it as a PDF.
                </p>
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    onClick={handleDownload}
                    className="inline-flex items-center gap-2 px-6 py-3 border border-slate-700 hover:border-slate-500 text-slate-300 hover:text-white font-semibold rounded-xl transition-all duration-200 hover:-translate-y-0.5"
                  >
                    <Printer size={18} />
                    Print / Save as PDF
                  </button>
